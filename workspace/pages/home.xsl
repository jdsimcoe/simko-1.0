...
<xsl:template match="data">
  ...
  <div class="about">
    ...
    <div class="container">
      ...
      <p>I have worked on and off for the past six years doing freelance Web, graphic and print design work, consulting on the creative process with startups and developing a passion to think beyond visual design and dream up rich and usable experiences for consumers.</p>
      <p>I have a passion for learning and am excited about the direction of the Web, as well as how technologies such as HTML5 and mobile-optimized design are facilitating great content and taking on a variety of forms to reach new audiences. This site and my other projects embrace new technologies like HTML5, responsive design and imagery (including retina), and open standard such as XML and XSLT.</p>
      <hr/>
